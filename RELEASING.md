...
downloads are also published at `https://github.com/dantearo/arkex-cli`.
...
gh release create v0.1.0 --repo dantearo/arkex-cli --verify-tag \
...
`dantearo/arkex-cli`. Default URL: `https://dantearo.github.io/arkex-cli/`.
